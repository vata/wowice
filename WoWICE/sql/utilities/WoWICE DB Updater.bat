...
REM # Website http://code.google.com/p/wowice/
REM ############################################################################
REM # 
...
CLS
ECHO.
ECHO Welcome to the WoWICE DB Updater! Please enter your MySQL Info...
ECHO.
...
ECHO	 #          Website http://code.google.com/p/wowice/          #
ECHO	 ##############################################################
ECHO		 ####################################
ECHO		 #######    WoWICE Database   #######
ECHO		 ######        Revision        ######
ECHO		 #######      Update Tool     #######
ECHO		 ####################################
ECHO.
...
ECHO [Importing] WoWICE World Updates ...
...
ECHO.
ECHO [Importing] Started...
ECHO [Importing] WoWICE Character Updates ...
...
ECHO.
ECHO [Importing] Started...
ECHO [Importing] WoWICE Logon Updates ...

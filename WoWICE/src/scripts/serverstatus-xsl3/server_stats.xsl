...
<xsl:template match="/">
	...
	<body id="top">
		<center><div id="container">
		  <span class="important"><a href="http://code.google.com/p/wowice/"><img src="images/banner.gif" alt="ArcEmu Server Status" width="680" height="90" border="0" /></a></span><br />
		  <div id="links">
        <div align="center"></div>
        <div class="banner">
          <div align="center">Welcome to WoWICE's server stats page, you may want to change this message :) </div>
        </div>
        <div class="sitelinks" align="center">
        <a href="http://code.google.com/p/wowice/">Home</a> | <a href="http://code.google.com/p/wowice/">Signup</a> | <a href="http://code.google.com/p/wowice/">Forums</a>
        | Other </div>
		</div>
		<xsl:apply-templates/>

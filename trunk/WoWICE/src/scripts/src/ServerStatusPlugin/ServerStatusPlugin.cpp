...
#include "StdAfx.h"
#include "../../../wowice-shared/svn_revision.h"
...
#ifdef WIN32
		fprintf(f, "    <platform>wowice %s r%u/%s-Win-%s (http://code.google.com/p/wowice/)</platform>\n", BUILD_TAG, BUILD_REVISION, CONFIG, ARCH);		
#else
		fprintf(f, "    <platform>wowice %s r%u/%s-%s (http://code.google.com/p/wowice/)</platform>\n", BUILD_TAG, BUILD_REVISION, PLATFORM_TEXT, ARCH);
#endif

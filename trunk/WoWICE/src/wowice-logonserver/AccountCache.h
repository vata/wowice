...
public:
	...
	WoWICE_INLINE size_t GetCount() { return AccountDatabase.size(); }
...
public:
	...
	WoWICE_INLINE Mutex & getServerSocketLock() { return serverSocketLock; }
	WoWICE_INLINE Mutex & getRealmLock() { return realmLock; }
	...
	WoWICE_INLINE void   AddServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.insert( sock ); serverSocketLock.Release(); }
	WoWICE_INLINE void   RemoveServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.erase( sock ); serverSocketLock.Release(); }
